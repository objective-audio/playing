//
//  yas_playing_audio_buffering_element.cpp
//
...
audio_buffering_element::audio_buffering_element(audio::format const &format, sample_rate_t const frag_length)
    : _frag_length(frag_length), _buffer(format, frag_length) {
}

[[nodiscard]] audio_buffering_element::state_t audio_buffering_element::state() const {
    return this->_current_state;
}

[[nodiscard]] frame_index_t audio_buffering_element::begin_frame_on_render() const {
...
[[nodiscard]] fragment_index_t audio_buffering_element::fragment_index_on_render() const {
...
[[nodiscard]] bool audio_buffering_element::write_if_needed_on_task(path::channel const &ch_path) {
...
void audio_buffering_element::force_write_on_task(path::channel const &ch_path, fragment_index_t const frag_idx) {
...
bool audio_buffering_element::contains_frame_on_render(frame_index_t const frame) {
    if (this->_current_state.load() != state_t::readable) {
        return false;
    }
...
bool audio_buffering_element::read_into_buffer_on_render(audio::pcm_buffer *out_buffer, frame_index_t const frame) {
    if (this->_current_state.load() != state_t::readable) {
        throw std::runtime_error("state is not reading.");
    }
...
void audio_buffering_element::advance_on_render(fragment_index_t const frag_idx) {
    if (this->_current_state.load() != state_t::readable) {
        return;
    }
...
void audio_buffering_element::overwrite_on_render() {
    if (this->_current_state.load() != state_t::readable) {
        return;
    }
...
audio::pcm_buffer const &audio_buffering_element::buffer_for_test() const {
    return this->_buffer;
}

bool audio_buffering_element::_write_on_task(path::channel const &ch_path) {
    this->_buffer.clear();
...
audio_buffering_element_ptr audio_buffering_element::make_shared(audio::format const &format,
                                                                 sample_rate_t const frag_length) {
    return audio_buffering_element_ptr{new audio_buffering_element{format, frag_length}};
}
