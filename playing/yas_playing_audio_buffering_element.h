//
//  yas_playing_audio_buffering_element.h
//
...
struct audio_buffering_element : audio_buffering_element_protocol {
    ...
    [[nodiscard]] static audio_buffering_element_ptr make_shared(audio::format const &,
   ...
   private:
    ...
    audio_buffering_element(audio::format const &, sample_rate_t const frag_length);
