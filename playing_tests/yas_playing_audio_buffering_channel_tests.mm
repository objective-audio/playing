//
//  yas_playing_audio_buffering_channel_tests.mm
//
...
struct element : audio_buffering_element_protocol {
...
static std::shared_ptr<element> cast_to_element(audio_buffering_element_protocol_ptr const &protocol) {
    return std::dynamic_pointer_cast<element>(protocol);
}
}

@interface yas_playing_audio_buffering_channel_tests : XCTestCase

@end

@implementation yas_playing_audio_buffering_channel_tests
